	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (empty($country_id)) {
				...
				$this->model_account_customerpartner->becomePartnerseller($this->request->post['shoppartner'],$customer_country_id='',$this->customer->getId(),$this->request->post['description'], $secid_m, $subsecid_m );
			}else{

				$this->model_account_customerpartner->becomePartnerseller($this->request->post['shoppartner'],$country_id['country_id'],$this->customer->getId(),$this->request->post['description'], $secid_m, $subsecid_m );
			}

...
$('#button-quote').on('click', function() {
	$.ajax({
        ...
        /*--*/
				...
				html += '        <input type="button" value="<?php echo "Pilih Ongkir"; ?>" id="button-shipping" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary button" />';
				<?php } else { ?>
				html += '        <input type="button" value="<?php echo "Pilih Ongkir"; ?>" id="button-shipping" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary button" disabled="disabled" />';
				<?php } ?>

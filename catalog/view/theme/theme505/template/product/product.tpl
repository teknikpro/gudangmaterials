				...
				<div id="product">
					...
					<?php if ($_SERVER["SERVER_NAME"] != "tokobahanbangunan-online.com") { ?>
						<div class="form-group form-horizontal">
							...
							<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-add"><i class="fa fa-shopping-cart"></i><span><?php echo $button_cart; ?></span></button>
						</div>
					<?php } ?>

					<ul class="product-buttons">
						<?php if ($_SERVER["SERVER_NAME"] != "tokobahanbangunan-online.com") { ?>
							<li><button class="btn btn-default" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i> <span class="hidden-sm"><?php echo $button_wishlist; ?></span></button></li>
						<?php } ?>
						<li><button type="button" class="btn btn-default" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i> <span class="hidden-sm"><?php echo $button_compare; ?></span></button></li>
					</ul>					
				...
				<li>
					<div class="product-thumb transition">
						...
						<div class="cart-button">
							...
							<?php } ?>
							<?php } ?>
							<div class="description"><?php echo mb_substr($product['description'],0,58,'UTF-8').'...';?></div>
							<div>
							    <?php if ($_SERVER["SERVER_NAME"] != "tokobahanbangunan-online.com") { ?>
								<button data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-icon btn-add" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>"><i class="fa fa-shopping-cart"></i></button>

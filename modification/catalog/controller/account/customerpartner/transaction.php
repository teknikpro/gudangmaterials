  	...
  	public function getlist() {
	    ...
	    foreach ($results as $result) {
	      	...
	      	$data['transactions'][] = array(
				...
				'id' => $result['id'],
				'name' => $result['name'],
				'value' => number_format($result['amount']),
				'ongkir' => number_format($result['ongkir']),
				'total' => number_format($result['amount'] + $result['ongkir']),
				'details' => $result['details'],
				'date' => $result['date_added'],
				'linkdetail' => $this->url->link('account/customerpartner/orderdetail&order_id='. $result['order_id'] .'')
			);

              ...
              <tbody>
                ...
                <tr>
                    ...
                    <?php if($partners){ ?>
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="hidden" value="<?php echo $information['information_id']?>" />
                          <select class="form-control partner_change">
                            <option value="0"></option>
                          <?php foreach($partners as $partner){ ?>
                            <?php if($information['seller_id'] == $partner['customer_id']){ ?>
                  ...
                  <td class="text-center">
                    <a data-toggle="tooltip" title="<?php echo $text_approve; ?>" class="btn btn-success <?php echo !$information['status'] ? 'cp-pro-status' : ''; ?>" <?php echo $information['status'] ? "disabled" : ""; ?> id="<?php echo $information['information_id']?>"><i class="fa fa-thumbs-o-up"></i></a>
                  </td>
...
<script type="text/javascript">
    ...
    var information_id = $(this).attr('id');
		...
		$.ajax({
			url : 'index.php?route=customerpartner/information/approve&token=<?php echo $token; ?>',
  ...
  $('.partner_change').on('change', function() {
    ...
    $.ajax({
      url : 'index.php?route=customerpartner/information/changeSeller&token=<?php echo $token; ?>',

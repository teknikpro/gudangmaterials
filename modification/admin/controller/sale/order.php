...
class ControllerSaleOrder extends Controller {
	...
	public function invoice() {
		...
		$idseller = $this->model_customerpartner_konfirmasiongkir->getIdSellerOrder($this->request->get['order_id']);
		$addres_id = $this->model_customerpartner_konfirmasiongkir->getAddressIdSeller($idseller['customer_id']);
		$sellerData = $this->model_customerpartner_konfirmasiongkir->getDataSeller($addres_id['address_id']);
		...
		$idcustomer = $this->model_customerpartner_konfirmasiongkir->getIdCustomerOrder($this->request->get['order_id']);
		$customeraddress = $this->model_customerpartner_konfirmasiongkir->getAddressIdSeller($idcustomer['customer_id']);
		$customerData = $this->model_customerpartner_konfirmasiongkir->getDataSeller($customeraddress['address_id']);
		...
		$dataPayment = $this->model_customerpartner_konfirmasiongkir->getDataPayment($this->request->get['order_id']);
		$data['payment_method'] = $dataPayment['payment_method'];
		$data['payment_code'] = $dataPayment['virtual_number'];
		$data['seller_firstname'] = $addres_id['firstname'];
		$data['seller_lastname'] = $addres_id['lastname'];
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				foreach ($totals as $total) {
					if ($total["title"] !== "Sub-Total" && $total["title"] !== "Total") {
						$datatitle = "Biaya Pengiriman " . $total['title'] ;
					}else {
						$datatitle = $total['title'];
					}
					$total_data[] = array(
						'title' => $datatitle,
						'text'  => $this->currency->format($total['value'], $order_info['currency_code'], $order_info['currency_value']),

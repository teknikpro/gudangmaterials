<?php
class ControllerAdminAffiliateForgotten extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['action'] = $this->url->link('adminaffiliate/forgotten', '', 'SSL');

		$data['back'] = $this->url->link('adminaffiliate/login', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/adminaffiliate/forgotten.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/adminaffiliate/forgotten.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/adminaffiliate/forgotten.tpl', $data));
		}
	}

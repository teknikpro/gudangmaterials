<?php
class ControllerAccountCustomerpartnerAutocomplete extends Controller {

	private $error = array();

	public function nama_brand() {
		$json = array();
			...
			$results = $this->model_account_customerpartner->getBrands($data);

			foreach ($results as $result) {
				$json[] = array(
					'id_brand' => $result['id_brand'],
					'nama_brand'            => strip_tags(html_entity_decode($result['nama_brand'], ENT_QUOTES, 'UTF-8'))
				);
			}
		...
		foreach ($json as $key => $value) {
			$sort_order[$key] = $value['nama_brand'];
		}

...
<div id="container" class="container j-container">
  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
     <center><h2><font size="5" color="green"><?php echo $heading_title; ?></font></h2></center><br>
              ...
              <?php foreach ($this->journal2->settings->get('refine_category_images', array()) as $category): ?>
               <!--<div class="product-grid-item <?php echo $this->journal2->settings->get('product_grid_classes'); ?> display-<?php echo $this->journal2->settings->get('product_grid_wishlist_icon_display'); ?> <?php echo $this->journal2->settings->get('product_grid_button_block_button'); ?>">-->
                ...
                <div class="refine-image swiper-slide <?php echo Journal2Utils::getProductGridClasses($this->journal2->settings->get('refine_category_images_per_row'), $this->journal2->settings->get('site_width', 1024), $this->journal2->settings->get('config_columns_count')); ?> ">         
				 ...
				 <!--<a href="<?php echo $category['href']; ?>"><span class="refine-category-name"><strong><font size="3" style="color:#F97001"><?php echo $category['name']; ?></font></strong></span></a>-->
				 <!--<a href="<?php echo $category['href']; ?>"><span class="refine-category-name"><strong><font size="3" style="color:#F97001"><?php echo $category['name']; ?></font></strong></span></a>-->
               
               
				 <!--<a href="<?php echo $category['href']; ?>"><font size="3" style="color:#F97001"><center><?php echo $category['name']; ?></center></font></a>-->
      ...
      <div class="product-filter">
        ...
        <div class="limit"><b><font size="3" style="color:#FFF"><?php echo $text_limit; ?></font></b>
        ...
        <div class="sort"><b><font size="3" style="color:#FFF"><?php echo $text_sort; ?></font></b>
          <select onchange="location = this.value;">
            ...
            <div class="product-details">
              <div class="caption">
                <h4 class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h4>
				  <!--<p><strong><center><font size="1" color="black"><?php echo $text_supplied; ?><?php echo $product['screenname']; ?></font></center></strong></p>-->
				   <!--<p><strong><center><font size="1" color="black"><?php echo $text_supplied; ?> <?php echo $product['seller_name']; ?></font></center></strong></p>-->
				   <!--<p><strong><center><font size="1" color="black"><?php echo "Model :"; ?> <?php echo $product['model']; ?></font></center></strong></p>-->
                   <?php if ($data['switch']==1) { ?>
					<strong class=" view-des-grid display-grid" ><font size="1" color="black"><?php echo $product['description2']; ?></font></strong>
					<strong class=" view-des-list display-list" ><font size="1" color="black"><?php echo $product['description']; ?></font></strong>
				   <?php } else { ?>
				     <!-- <?php if($this->journal2->settings->get('refine_category') != 'grid' ) { ?> -->
				        <strong class=" view-des-grid display-grid"><font size="2" color="black"><?php echo $product['description2']; ?></font></strong>
				        <strong class=" view-des-list display-list"><font size="2" color="black"><?php echo $product['description']; ?></font></strong>
					 <!-- <?php } else { ?> -->
					    <!-- <strong class=" view-des-grid display-grid" ><font size="2" color="black"><?php echo $product['description']; ?></font></strong> -->
					  <!--<?php } ?> -->
				   <?php } ?>
					<!--<center><strong><font size="2" style="color:#0b7528"><?php echo "Supplied by : "; ?></font></strong> <strong><font size="2" style="color:#000000"><?php echo $product['model']; ?></font></strong> </center> --> 

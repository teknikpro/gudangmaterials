    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="buttons">
        <div class="pull-right">
          <button type="submit" form="form-information" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary button"><i class="fa fa-save"></i></button>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tabs-content">
            <div class="tab-pane tab-content active" id="tab-general">
              ...
              <div class="tabs-content">
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane tab-content" id="language<?php echo $language['language_id']; ?>">
...
<?php foreach ($languages as $language) { ?>
  CKEDITOR.replace('information_description[<?php echo $language["language_id"]; ?>][description]', {

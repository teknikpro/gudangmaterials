        ...
        <table class="table table-bordered table-hover list">
          <thead>
            <tr>
              ...
              <td class="text-left">
                <a href="#" class="text-decoration-none">Ongkos Kirim</a>
              </td>
              ...
              <td class="text-left">
                <a href="#" class="text-decoration-none">Total</a>
              </td>
              <td class="text-left">
                <a href="#" class="text-decoration-none">Detail Transaksi</a>
              </td>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <?php foreach ($transactions as $result) { ?>
              <tr>
                ...
                <td class="text-left">Rp. <?php echo $result['value']; ?></td>
                ...
                <td class="text-left">Rp. <?php echo $result['total']; ?></td>
                <td class="text-left"><a href='<?= $result['linkdetail'] ?>' style="text-decoration:none; color:darkblue;" >Detail</a></td>
              </tr>
            <?php } ?>
            <?php } else { ?>
            <tr>

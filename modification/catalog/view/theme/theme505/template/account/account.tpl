...
<li><i class="fa fa-credit-card"></i> <a href="<?php echo $confirm_payment; ?>"><?php echo $text_confirm_payment; ?></a></li>

<?php if($check_order_status) { ?> 
<li><i class="fa fa-truck"></i> <a href="<?php echo $check_order_status; ?>"><?php echo $text_check_order_status; ?></a></li>
<?php } ?>

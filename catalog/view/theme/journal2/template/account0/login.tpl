...
<script src="https://www.gstatic.com/firebasejs/4.13.0/firebase-app.js"></script>
 ...
 <!--<script src="catalog/view/theme/journal2/js/firebase-messaging.js"></script>-->
        ...
        messaging.onTokenRefresh(function () {
            messaging.getToken()
                .then(function (refreshedToken) {
                    window.alert('Token refreshed.');                 tokenElement.innerHTML = "Token is " + refreshedToken;
                }).catch(function (err) {

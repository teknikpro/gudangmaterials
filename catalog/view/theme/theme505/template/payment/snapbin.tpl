 ...
 <?php
  ...
  ?>
        ...
        <?php if ($disable_mixpanel == 0){?>
         trackResult(data, merch_id, 'oc2_bin_specific_payment', 'pay', null);
        <?php } ?>
        ...
        snap.pay(data, {
          ...
          onSuccess: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_bin_specific_payment', 'success', result);
            <?php } ?>
          ...
          onPending: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_bin_specific_payment', 'pending', result);
            <?php } ?>
          ...
          onError: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_bin_specific_payment', 'error', result);
            <?php } ?>
          ...
          onClose: function(){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_bin_specific_payment', 'close');
            <?php } ?>

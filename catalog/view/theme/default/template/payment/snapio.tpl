  ...
  ?>
        ...
        snap.pay(data, {
          ...
          onSuccess: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_installment_offline', 'success', result);
            <?php } ?>
          ...
          onPending: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_installment_offline', 'pending', result);
            <?php } ?>
          ...
          onError: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_installment_offline', 'error', result);
            <?php } ?>
          ...
          onClose: function(){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_installment_offline', 'close');
            <?php } ?>

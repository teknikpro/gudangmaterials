...
class ControllerCommonMenu extends Controller {
	public function index() {
		$this->load->language('common/menu');
            ...
            $data['text_hp_order_tracking'] = $this->language->get('text_hp_order_tracking');
			if(isset($this->session->data['token'])) {
		      $data['hp_order_tracking'] = $this->url->link('module/hp_tracking_setting', 'token=' . $this->session->data['token'], true);      
		  }
		...
		$data['text_information2'] = $this->language->get('text_information2');
		...
		$data['information2'] = $this->url->link('catalog/information2', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['menu_text_categories'] = $this->language->get('menu_text_categories');
        $data['menu_text_seller_categories'] = $this->language->get('menu_text_seller_categories');
        $data['menu_text_information'] = $this->language->get('menu_text_information');
        $data['menu_text_categories_mapping'] = $this->language->get('menu_text_categories_mapping');
        $data['menu_text_notifications'] = $this->language->get('menu_text_notifications');
        $data['menu_text_order'] = $this->language->get('menu_text_order');
        $data['menu_text_konfirmasiongkir'] = $this->language->get('menu_text_konfirmasiongkir');
        ...
        $data['menu_text_review_field'] = $this->language->get('menu_text_review_field');
        $data['cp_review_field'] = $this->url->link('customerpartner/reviewfield', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['cp_categories'] = $this->url->link('customerpartner/category', 'token=' . $this->session->data['token'], 'SSL');
        $data['cp_sellercategories'] = $this->url->link('customerpartner/sellercategory', 'token=' . $this->session->data['token'], 'SSL');
        $data['cp_information'] = $this->url->link('customerpartner/information', 'token=' . $this->session->data['token'], 'SSL');
        $data['cp_category_mapping'] = $this->url->link('customerpartner/categorymapping', 'token=' . $this->session->data['token'], 'SSL');
        $data['cp_order'] = $this->url->link('customerpartner/order', 'token=' . $this->session->data['token'], 'SSL');
        $data['cp_konfirmasiongkir'] = $this->url->link('customerpartner/konfirmasiongkir', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['notifications'] = $this->url->link('customerpartner/notification', 'token=' . $this->session->data['token'],'SSL');

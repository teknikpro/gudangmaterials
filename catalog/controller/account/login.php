...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
        ...
        //---
				...
				//$this->response->redirect($this->url->link('customerpartner/sell', '', 'SSL'));
			}
		}
        ...
        //---
			...
			//$product_info_ = $this->model_customerpartner_master->getCekChattingSellerID( $customer_id);
		   ...
		   // }
			...
			if (isset($this->request->post['redirect']) && (strpos($this->request->post['redirect'], $this->config->get('config_url')) !== false || strpos($this->request->post['redirect'], $this->config->get('config_ssl')) !== false)) {
				...
				//$this->response->redirect($this->url->link('account/account', '', 'SSL'));
				//$this->response->redirect($this->url->link('customerpartner/sell', '', 'SSL'));  https://servertest2020.my.id/index.php?route=customerpartner/profile&id=19
              ...
              //if ($this->config->get('marketplace_status') && $this->model_account_customerpartner->chkIsPartner()) {		
				  //$check_seller = 0 ;
				//$check_seller = $this->model_account_customerpartner->checkIsMemberX($this->request->post['customer_id']);
				  //$check_seller = $this->model_customerpartner_master->getCekChattingSellerID($this->request->post['customer_id']);
				  //$seller_id = 0;
				  //$product_info_ = 0;

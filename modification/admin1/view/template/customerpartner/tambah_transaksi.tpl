            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php if($orders) {
                  ...
                  <?php } ?>
                  <tr>
                    <td colspan="10" class=" text-primary"  > <strong>Ongkos Kirim</strong></td>
                    <td colspan="2" ><strong>Rp. <?= $order['ongkos_kirim'];  ?></strong></td>
                  </tr>
                  <tr>
                    <td colspan="10" class=" text-primary"  > <strong>Pembelian</strong></td>
                    <td colspan="2" ><strong>Rp. <?= $order['total_komisi']; ?></strong></td></td>
                  </tr>
                  <tr>
                    <td colspan="10" class=" text-primary"  > <strong>Total Pembayaran</strong></td>
                    <td colspan="2" ><strong>Rp. <?= $order['total_pembayaran']; ?></strong></td></td>
                  </tr>
                <?php } else { ?>

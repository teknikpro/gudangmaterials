...
class ControllerAccountLogin extends Controller {
        ...
        //---
			...
			if (isset($this->request->post['redirect']) && (strpos($this->request->post['redirect'], $this->config->get('config_url')) !== false || strpos($this->request->post['redirect'], $this->config->get('config_ssl')) !== false)) {
		        ...
		        if ($product_info_) {		
					...
					if($this->session->data['product_redirect']){
						$this->response->redirect($this->session->data['product_redirect']);
						unset($this->session->data['product_redirect']);
					}else {
						$this->response->redirect($this->url->link('information/information','information_id=24', 'SSL'));
					}
	...
	protected function validate() {
		...
		//	$this->error['warning'] = $this->language->get('error_aktivasi');
		//}
	...
	public function AksesKeyAuth_email() {
			
    //echo '<script>alert("just moment please...")</script>';
	
		
		
		//echo '<script>alert("just moment please...")</script>';
		//echo "<script>localStorage.setItem('auth_email','xyz@gmail.com')</script>";

            ...
            <div class="product-grid-item isotope-element <?php echo implode(' ', $product['section_class']); ?> <?php echo $grid_classes; ?> display-<?php echo $this->journal2->settings->get('product_grid_wishlist_icon_display');?> <?php echo $this->journal2->settings->get('product_grid_button_block_button');?> <?php echo $product['classes']; ?>">
                <div class="product-wrapper <?php echo isset($product['labels']) && is_array($product['labels']) && isset($product['labels']['outofstock']) ? 'outofstock' : ''; ?>" style="<?php echo $image_bgcolor; ?>">
                    ...
                    <div class="image <?php echo $this->journal2->settings->get('show_countdown', 'never') !== 'never' && isset($product['date_end']) && $product['date_end'] ? 'has-countdown' : ''; ?>">
                        <font size="2" color="black"><a href="<?php echo $product['href']; ?>" <?php if(isset($product['thumb2']) && $product['thumb2']): ?> class="has-second-image" style="<?php echo $image_border_css; ?>;background: url('<?php echo $product['thumb2']; ?>') no-repeat;" <?php else: echo $image_border_css; endif; ?>>
                    ...
                    <div class="product-details">
                        <div class="caption">
                        <div class="name"><a href="<?php echo $product['href']; ?>"><b><font size="2" style="color:#F97001"><?php echo $product['name']; ?></font></b></a></div>
						<!--<p><center><strong><font size="1" color="black"><?php echo $product['description']; ?></font></strong></center></p>-->
                        <!--<div class="description"><?php echo $product['description']; ?></div>-->
						<p><strong><center><font size="1" color="black"><?php echo "Supplied by :"; ?><br> <?php echo $product['seller_name']; ?></font></center></strong></p>

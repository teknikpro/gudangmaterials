...
<div id="container" class="container j-container">
  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="product-page-content" itemscope itemtype="http://schema.org/Product">
      ...
      <h1 class="heading-title" itemprop="name"><center><font size="5" style="color:#F97001"><?php echo $heading_title; ?></font></center></h1>
      <?php endif; ?>
      ...
      <div class="row product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>">
        ...
        <div class="right">
          ...
          <ul class="list-unstyled description">
           ...
           <li class="product-views-count"><?php echo $this->journal2->settings->get('product_page_options_views_text'); ?>: <?php echo $this->journal2->settings->get('product_views'); ?> kali</li>
			 <!--<li class="product-views-count"><?php echo "Dilihat "; ?>: <?php echo $this->journal2->settings->get('product_views'); ?> kali</li> -->
			...
			<li><?php echo "Lokasi :"; ?> <?php echo $location; ?></li>
            <?php if ($reward) { ?>
            <li class="p-rewards"><?php echo $text_reward; ?> <span class="p-rewards"><?php echo $reward; ?></span></li>
            <?php } ?>
			
			
            <li class="p-stock"><?php echo $text_stock; ?> <span class="journal-stock <?php echo isset($stock_status) ? $stock_status : ''; ?>">
			<?php if ($stock != "77777" ) { ?>
			<?php echo $stock; ?><?php echo $sku; ?>
			<?php } ?></span><?php echo $sku; ?></li> 

                <?php if($wk_custome_field_wkcustomfields) { ?>
                    <?php if(!empty($customFields)) {
                        foreach ($customFields as $key => $value) { ?>
                            <li class="p-model"><?php echo $value['fieldName']; ?>: <span class="p-model" itemprop="model"> <?php echo $value['fieldValue']; ?></span></li>
                        <?php }
                    }
                } ?>
          ...
          <?php endif; ?>
                ...
                <?php if (isset($delivery_date) && $delivery_date) { ?>
                    <ul class="list-unstyled">
                        <li><?php echo $text_delivery_date .' : '.$delivery_date; ?> </li>
                    </ul>
                <?php } ?>
          ...
          <ul class="list-unstyled price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
            ...
            <?php endif; ?>
            <?php if (!$special) { ?>
            <li class="product-price"><strong><font size="4" style="color:#F97001"><?php echo $price; ?></font></strong><strong> <font size="4" color="blue">/<?php echo $sku; ?></font></strong>
			
			<?php if ($kategori_dagang == 0) { ?>
			 <!--catat<strong><font size="2"  color="red"> (Hubungi Kami di </font></strong> <a href="https://api.whatsapp.com/send?phone=6281912312380"><img alt="" height="20" src="https://tradelink-tokobahanbangunan-onlinemarketplace.com/image/catalog/wa.png" width="18" />)</a>-->
			<?php } ?>
			 
			 </li>
            <?php } else { ?>
            <li class="price-old"><?php echo $price; ?><strong> <font size="4" color="blue">/<?php echo $sku; ?></font></strong></li>
            <li class="price-new"><strong> <font size="4" style="color:#F97001"><?php echo $special; ?></font></strong> <strong> <font size="4" color="blue">/<?php echo $sku; ?>
			
			<?php if ($kategori_dagang == 0) { ?>
			<!--catat</font></strong><strong><font size="2"  color="red"> (Hubungi Kami di </font></strong> <a href="https://api.whatsapp.com/send?phone=6281912312380"><img alt="" height="20" src="https://tradelink-tokobahanbangunan-onlinemarketplace.com/image/catalog/wa.png" width="18" />)</a>-->
			<?php } ?>
			</li>
            <?php } ?>
            <!--<?php if ($tax) { ?>
            ...
            <li class="discounts"><?php echo $discount['quantity']; ?><?php echo $text_discount; ?><?php echo $discount['price']; ?><strong> <font size="6" color="blue">/<?php echo $sku; ?></font></strong></li>
            <?php } ?>
            <?php } ?>
          </ul>
          <?php } ?>
				...
				<?php if ($option['type'] == 'time') { ?>
					<div class="option form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
						...
						<div class="input-group time">
							<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="HH:mm" i
							<select name="recurring_id" class="form-control">d="input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
							<span class="input-group-btn">
							<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
							</span>
						</div>
		...
		<?php if($ceklogin) { ?>
			...
			<?php } else { ?>	
				...
				<?php else: ?>
					<span class="qty">
					<strong><font size="4" style="color:#F97001">
					<!--<label class="control-label text-qty" for="input-quantity"><?php echo $entry_qty; ?></label>-->
					<input type="hidden" name="quantity" value="<?php echo $minimum; ?>" size="2" data-min-value="<?php echo $minimum; ?>" id="input-quantity" class="form-control" />
					<input type="hidden" name="product_id" value="<?php echo $product_id; ?>" /></font></strong>
	...
	<!--
					</font></strong><strong><font size="2"  color="red"> (Hubungi Kami di </font></strong> <a href="https://api.whatsapp.com/send?phone=6281912312380"><img alt="" height="20" src="https://tradelink-tokobahanbangunan-onlinemarketplace.com/image/catalog/wa.png" width="18" />)</a>
					-->		   
			<?php } ?>
		<?php } else { ?>
			<a href="<?= $link_login; ?>" class="button">Login Untuk Berbelanja</a>
		<?php } ?>
			...
			<?php if($ceklogin) { ?>
				...
				<span class="links">
					...
					<a onclick="addToCompare('<?php echo $product_id; ?>');"><font size="3" style="color:#000000"><?php echo $button_compare; ?></font></a>
				</span>
				</div>
				<?php if ($review_status) { ?>
				<div class="rating">
				...
				<?php } ?> 
					...
					<?php endif; ?>
						...
						<?php if (isset($showSellerInfo) && $showSellerInfo) {?>
						<style>
							...
							.product-info,.product-info .right .product-options{
								overflow: visible;
							}
						...
						<div id="wk_seller_info_container">
							<div style="padding: 10px;background-color: #FFF; color: #ddd; border-left: 1px solid;border-right: 1px solid; border-top: 1px solid; border-bottom: 1px solid;">
							<div id="wk_seller_info_profpic" >
							<!-- <img src="<?php echo $info_image; ?>" width="100%" height="100%" style="vertical-align:baseline;"> -->
							<img src="../image/avatar.png" width="100%" height="120%" style="vertical-align:baseline;"> 
							</div>
							<div id="wk_seller_info_box" style="background-color: #FFF; color: #000">
								<h4 style="margin-bottom: 20px;margin-top: 0px;font-size: 13px;"><b><?php echo $info_heading_text; ?></b></h4>
								<!--<a href="<?php echo $loadProfile; ?>"><p style="margin:0; line-height: 15px;"><?php echo $info_name; ?></a><a href="<?php echo $loadProfile; ?>"><img alt="" src="https://tradelink-tokobahanbangunan-onlinemarketplace.com/image/catalog/promo/horizontal_slide/Movie.gif" title="Klik disini lihat Profil Toko"></a></p>-->
								<a href="<?php echo $loadProfile; ?>"><span><font size="3"  color="red"><?php echo $info_name; ?></font></span></a><a href="<?php echo $loadProfile; ?>"><img alt="" src="https://tradelink-tokobahanbangunan-onlinemarketplace.com/image/catalog/promo/horizontal_slide/Movie.gif" height="12" width="22" title="Klik disini lihat Profil Toko"></a>
						...
						<?php if ($ispartnerkode_012==0) { ?>	
								...
								<a href="<?php echo $text_href; ?>">
								
									<font size="3" color="black"><strong><?php echo "Hubungi Penjual via Chatting"; ?> &nbsp;</strong></font><font size="3" color="green"><strong><i class='far fa-comments' style='font-size:24px'></i>	</strong></font>
								</a>
						...
						<?php if ($kategori_dagang == 0) { ?>
						<!-- catat <br></font></strong><strong><font size="2"  color="red"> (Hubungi Kami di </font></strong> <a href="https://api.whatsapp.com/send?phone=6281912312380"><img alt="" height="20" src="https://tradelink-tokobahanbangunan-onlinemarketplace.com/image/catalog/wa.png" width="18" />)</a>-->
						<?php } ?>						
								...
								<div id="wk_seller_info_rating_details">
									...
									<?php foreach($review_fields AS $review_field){ ?>
										...
										<div style="display: inline-block;width: 25%;"><?php echo $review_field['field_name']; ?></div>
										<div class="wk_rating_details" style="display: inline-block;font-size: 10px;">
											<?php for ($i = 1; $i <= 5; $i++) { ?>
											<?php if ($review_field['field_value'] < $i) { ?>
											<span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i></span>
											<?php } else { ?>
											<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
											<?php } ?>
											<?php } ?>
											<span>(<?php echo $review_field['field_value'] ? $review_field['field_value'] : 0; ?>/5)</span>
										</div>
										</div>
										<?php } ?>
										</div>
      ...
      <form id="seller-mail-form">
        <div class="modal-body">
          <div class="form-group required">
            ...
            <input type="text" name="subject" id="input-subject" class="form-control" style="width:95%;" />
          ...
          <div class="form-group required">
            ...
            <textarea class="form-control" name="message" style="width:95%;" rows="3" id="input-message"></textarea>
          </div>
...
$('#button-cart').on('click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
                if (!Journal.showNotification(json['success'], json['image'], false)) {
        ...
        error: function(xhr, ajaxOptions, thrownError) {
          alert( "\r\n" + "Dalam satu keranjang hanya boleh pilih barang dengan satu Penjual yang sama." );
        }
	});
});
//--></script> 
...
echo "<script src='catalog/view/theme/journal2/js/updatelink.js'></script>";
</font>

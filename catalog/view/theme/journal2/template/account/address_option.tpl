  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="<?php echo $class; ?> address-entry"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
          <td class="text-left"><?php echo $result['address']; ?> <br> <?php echo $result['telephone']; ?></td>
          <td class="text-right">
          <a href="<?php echo $result['update']; ?>" class="btn btn-danger button">Edit</a>
          <?php if( $jumlahdata !== 1  ) { ?>
              <a href="<?php echo $result['change']; ?>" class="btn btn-danger button">Pilih Alamat Ini</a>
          <?php } ?>
          </td>
        </tr>
        <?php } ?>

  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-heading">
        ...
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php  echo "Edit Chatting Reply"; ?></h3>
      ...
      <div class="panel-body">
        ...
        <!--<table id="images" class="list">
          ...
          <?php $image_row = 0; ?>
          <?php foreach ($chatting_images as $chatting_image) { ?>
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
              <td class="left"><?php foreach ($languages as $language) { ?>
                <input type="text" name="chatting_image[<?php echo $image_row; ?>][chatting_image_description][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($chatting_image['chatting_image_description'][$language['language_id']]) ? $chatting_image['chatting_image_description'][$language['language_id']]['title'] : ''; ?>" />
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
                <?php if (isset($error_chatting_image[$image_row][$language['language_id']])) { ?>
                <span class="error"><?php echo $error_chatting_image[$image_row][$language['language_id']]; ?></span>
                <?php } ?>
                <?php } ?></td>              
              <td class="left"><div class="image"><img src="<?php echo $chatting_image['thumb']; ?>" alt="" id="thumb<?php echo $image_row; ?>" />
                  <input type="hidden" name="chatting_image[<?php echo $image_row; ?>][image]" value="<?php echo $chatting_image['image']; ?>" id="image<?php echo $image_row; ?>"  />
                  <br />
          ...
          <tfoot>
            <tr>
              <td colspan="3"></td>
              <td class="left"><a onclick="addImage();" class="button"><?php echo $button_add_chatting; ?></a></td>
            </tr>
          </tfoot>
        </table>-->
        </form>

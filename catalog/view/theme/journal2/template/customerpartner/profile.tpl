...
<div id="container" class="container j-container">
  <div>
    <div id="content">
      <!--<div class="row row-journal companybanner" style="min-height:200px;">
	  ...
	  <center><font size="5" style="color:#F97001"><strong><div><?php echo $partner['firstname']." ".$partner['lastname']; ?></div></center></font></strong></br>
	  <center><font size="3" style="color:#99999"><strong><div><blink><span style="color: #0000FF;"><?php echo $text_connect; ?></span></blink>
	  
	                <?php if($logged) { ?>
                       <a data-target="#myModal-seller-mail" data-toggle="modal"> via email 
                        <i class="fa fa-envelope-o"></i>
                      </a>
                    <?php } else { ?>
                     <a href="<?php echo $login; ?>" data-toggle="tooltip" data-original-title="<?php echo $text_login_contact; ?>"> via email 
      ...
      <div class="row row-journal">
        <ul class="nav nav-tabs" style="display:flex;list-style: none;margin: 10px -3px;">
          <li class="active mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            <a href="#tab-profile" data-toggle="tab">
              <!--<center><img src="image/MP/profile.png" /></center>-->
			   <font size="2" color="black"><i class="fa fa-bank" style="font-size:30px"></i></font><br><br>
			   
               <strong><font size="2" color="black"><?php echo $text_profile; ?></font> </strong>
            </a>
          </li>
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            <!--<a href="#tab-store" data-toggle="tab">-->
			 <!--<a href="https://gudangmaterials.id/index.php?route=module/chatting/getchatting&chatting_id=11">-->
			...
			<?php if ($text_href) { ?>
                ...
                <a href="<?php echo $text_href; ?>">
				  ...
				  <font size="2" color="black"><i class='far fa-comments' style='font-size:30px'></i></font><br>

                  <!--<?php echo $text_store; ?>-->
				    <strong><font size="2" color="black"><?php echo "Chat Penjual"; ?></font> </strong>
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            <a href="#tab-collection" data-toggle="tab">
			  ...
			  <font size="2" color="black"><i class="far fa-list-ul" style="font-size:30px"></i></font><br>
               <strong><font size="2" color="black"><?php echo $text_collection.' ('.($collection_total ? $collection_total : '0').')'; ?></font> </strong>
            </a>
          </li>
          <?php } ?>
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            <a href="#tab-reviews" data-toggle="tab">
              <!--<center><img src="image/MP/review.png" /></center>--> 
			   <font size="2" color="black"><i class="far fa-pencil-square-o" style="font-size:30px"></i></font><br>
               <!--<strong><font size="2" color="black"><?php echo $text_reviews.' ('.($feedback_total ? round($feedback_total,1) : '0').')'; ?></font> </strong>-->
			   <strong><font size="2" color="black"><?php echo $text_reviews; ?></font> </strong>
            </a>
          </li>
          <?php } ?>
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            <a href="#tab-product-reviews" data-toggle="tab">
			  ...
			  <font size="2" color="black"><i class="far fa-clipboard" style="font-size:30px"></i></font><br>
              <strong><font size="2" color="black"><?php echo $text_product_reviews.' ('.($product_feedback_total ? $product_feedback_total : '0').')'; ?></font> </strong>
            </a>
          </li>
          <?php } ?>
        </ul>
        <div class="tab-contents">
          ...
          <div class="tab-pane tab-content active tab_style" style="text-align: justify;" id="tab-profile">
...
<?php } ?>
          ...
          <!-- tab-profile -->
          <?php if(isset($public_seller_profile) && in_array('store',$public_seller_profile)) { ?>
          <div id="tab-store" style="text-align: justify;" class="tab-pane tab-content tab_style">
          ...
          <?php if(isset($public_seller_profile) && in_array('review',$public_seller_profile)) { ?>
          <div id="tab-reviews" class="tab-pane tab-content tab_style">
          ...
          <?php if(isset($public_seller_profile) && in_array('productReview',$public_seller_profile)) { ?>
          <div id="tab-product-reviews" class="tab-pane tab-content tab_style"></div>
          <!-- tab-product-reviews -->
          <?php } ?>

          <?php if(isset($public_seller_profile) && in_array('collection',$public_seller_profile)) { ?>
          <div id="tab-collection" class="tab-pane tab-content tab_style"></div>
          <!-- tab-collection -->
          <?php } ?>
        ...
        <form class="form-horizontal" id="seller_review_form">
          <div class="form-group required">
            <div class="col-sm-12">
              ...
              <input type="text" name="name" value="" style="width:95%;" id="input-name" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
            <div class="col-sm-12">
  ...
  $('#button-review').on('click', function() {
    $.ajax({
      ...
      success: function(json) {
        ...
        if (json['error']) {
          $('#review-modal').after('<div class="alert alert-danger warning" style="width:95%;"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button class="close" type="button" data-dismiss="alert" >&times;</button></div>');
        }
        if (json['success']) {
          $('.alert-success').remove();
          $('#review-modal').prepend('<div class="alert alert-success success" style="width:95%;"><i class="fa fa-check-circle"></i> ' + json['success'] + '</div>');
          $('input[name=\'name\']').val('');

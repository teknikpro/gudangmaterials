                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php } ?>
                                    ...
                                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="user">
                                        <div class="form-group">
                                            <input type="email" name="email" value="<?php echo $email; ?>" class="form-control form-control-user"  placeholder="Masukan Email" required>
                                        </div>
                                        <div class="form-group">
                                            <input name="password" value="<?php echo $password; ?>" type="password" class="form-control form-control-user" placeholder="Password" required>
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= $forgotten; ?>">Forgot Password?</a>
                                    </div>
                                </div>
                            </div>
                        </div>

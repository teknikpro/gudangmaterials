...
class ControllerModuleAccount extends Controller {
	public function index() {
		...
		$data['text_forgotten'] = $this->language->get('text_forgotten');
            ...
            $data['text_check_order_status'] = $this->config->get('hp_tracking_heading_title_'.$this->config->get('config_language_id'));
            $data['check_order_status'] = $this->url->link('account/cekstatusorder', '', false);

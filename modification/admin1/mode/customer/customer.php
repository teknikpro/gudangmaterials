...
class ModelCustomerCustomer extends Model {
		...
		$customer_id = $this->db->getLastId();
                ...
                if ($this->config->get('marketplace_status') && $create_seller) {
	...
	public function deleteCustomer($customer_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "customerpartner_to_sellercategory WHERE seller_id = '" . (int)$customer_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "customerpartner_to_payment WHERE customer_id = '" . (int)$customer_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "customerpartner_to_information WHERE seller_id = '" . (int)$customer_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "customerpartner_to_transaction WHERE customer_id = '" . (int)$customer_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "customerpartner_to_feedback WHERE customer_id = '" . (int)$customer_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "customerpartner_to_category WHERE seller_id = '" . (int)$customer_id . "'");
	...
	public function deleteMember($email_member,$userid){
		$this->db->query("DELETE FROM tbl_member WHERE useremail like  '". $this->db->escape(utf8_strtolower((string)$email_member)) . "'");
		$this->db->query("DELETE FROM tbl_konsultan_jadwal WHERE userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_chat WHERE to_userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_chat WHERE from_userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_chat_message WHERE to_userid = '" . (int)$userid . "'");		
		$this->db->query("DELETE FROM tbl_chat_message WHERE from_userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_member_konfirmasi WHERE userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_member_log WHERE userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_stats WHERE userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM tbl_konsutan_rate WHERE userid = '" . (int)$userid . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "sessionlink WHERE email like  '". $this->db->escape(utf8_strtolower((string)$email_member)) . "'");
	    $this->db->query("DELETE FROM " . DB_PREFIX . "customer_login WHERE email like  '". $this->db->escape(utf8_strtolower((string)$email_member)) . "'");
					
	}
	
	public function getMemberMail($customer_id) {
	...
	public function getMemberUserID($email_member) {
		$query = $this->db->query("SELECT userid FROM tbl_member WHERE useremail like  '" . $this->db->escape(utf8_strtolower((string)$email_member)) . "'");

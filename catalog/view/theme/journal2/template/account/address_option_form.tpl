    ...
    <div id="content" class="<?php echo $class; ?> edit-address"> <?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-lastname">Telepon</label>
            <div class="col-sm-10">
              <input type="text" name="telphone" value="<?php echo $telephone; ?>" placeholder="Masukan Nomor Telepon" id="input-lastname" class="form-control" required />

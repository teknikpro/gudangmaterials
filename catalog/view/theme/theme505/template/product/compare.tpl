	...
	<div class="table-responsive">
	  <table class="table table-bordered">
		...
		<tbody>
		  ...
		  <tr>
			...
			<td class="text-center"><?php if ($products[$product['product_id']]['thumb']) { ?>
			  <a href="<?php echo $product['href']; ?>"><img src="<?php echo $products[$product['product_id']]['thumb']; ?>" alt="<?php echo $products[$product['product_id']]['name']; ?>" title="<?php echo $products[$product['product_id']]['name']; ?>" class="img-thumbnail" /></a>
			  <?php } ?></td>
			<?php } ?>
		  </tr>
		...
		<tr>
		  ...
		  <td>
		  	<?php if ($_SERVER["SERVER_NAME"] != "tokobahanbangunan-online.com") { ?>
		  	<input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>');" />
		  	<?php } ?>

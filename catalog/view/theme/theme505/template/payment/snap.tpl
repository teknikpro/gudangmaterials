 ...
 <?php
  ...
  ?>
        ...
        <?php if ($disable_mixpanel == 0){?>
          trackResult(data, merch_id, 'oc2_fullpayment', 'pay', null);
        <?php } ?>
        ...
        snap.pay(data, {
          ...
          onSuccess: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_fullpayment', 'success', result);
            <?php } ?>
          ...
          onPending: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_fullpayment', 'pending', result);
            <?php } ?>
          ...
          onError: function(result){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_fullpayment', 'error', result);
            <?php } ?>
          ...
          onClose: function(){
            <?php if ($disable_mixpanel == 0){?>
              trackResult(data, merch_id, 'oc2_fullpayment', 'close');
            <?php } ?>

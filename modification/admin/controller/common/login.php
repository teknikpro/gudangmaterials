...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		$query = $this->db->query("SHOW COLUMNS FROM ".DB_PREFIX."download_description LIKE 'description'");
		if (!$query->num_rows)
			$this->db->query("ALTER TABLE ".DB_PREFIX."download_description ADD description text NOT NULL DEFAULT ''");			

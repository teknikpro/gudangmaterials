...
Journal.gridView = function () {
    $('.view-des-grid').addClass('display-grid').removeClass('display-list');
    $('.view-des-list').addClass('display-list').removeClass('display-grid');
...
Journal.listView = function () {
    $('.view-des-grid').addClass('display-list').removeClass('display-grid');
    $('.view-des-list').addClass('display-grid').removeClass('display-list');

...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['anti_spam'])) {
			$data['anti_spam'] = $this->error['anti_spam'];
		} else {
			$data['anti_spam'] = '';
		}
	...
	protected function validate() {
		...
		{
			$api_url = 'https://www.google.com/recaptcha/api/siteverify?secret=6LcEJV8qAAAAAPViikbkfeH3xqoOLGipIg8coK7q&response='.$_POST['g-recaptcha-response'];
			...
			{
				$this->error['anti_spam'] = "Anda wajib menceklis ini";

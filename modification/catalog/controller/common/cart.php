	...
	public function index() {
		...
		foreach ($this->cart->getProducts() as $product) {
			...
			$data['products'][] = array(
				...
				'seller_name'     => $checkSellerProduct ? $checkSellerProduct['screenname']: '',
                'seller_href'      =>$checkSellerProduct ? $this->url->link('customerpartner/profile', 'id=' . $checkSellerProduct['customer_id'],'SSL'): '',

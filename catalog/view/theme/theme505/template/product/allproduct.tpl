...
<div class="container">
  <ul class="breadcrumb">
    <?php $breadcrumbs['1']['text'] =$heading_title; ?>
      ...
      <div class="image"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a>      
        ...
        <div class="cart-button">
         <?php if ($_SERVER["SERVER_NAME"] != "tokobahanbangunan-online.com") { ?>
          ...
          <div class="description_list"><?php echo $product['description']; ?></div>
          <div class="description"><?php echo mb_substr($product['description'],0,65,'UTF-8').'...';?></div>        

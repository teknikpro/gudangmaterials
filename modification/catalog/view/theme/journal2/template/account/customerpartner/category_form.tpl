    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="buttons">
        <div class="pull-right">
          <button type="submit" form="form-category" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary button"><i class="fa fa-save"></i></button>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tabs-content">
            <div class="tab-pane tab-content active" id="tab-general">
              <ul class="nav nav-tabs htabs" id="languages">
            ...
            <div class="tab-pane tab-content" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="image" value="<?php echo $image; ?>" id="image-target-image" />
...
<?php foreach ($languages as $language) { ?>
  CKEDITOR.replace('category_description[<?php echo $language["language_id"]; ?>][description]', {
...
'source': function(request, response) {
  $.ajax({
    url: 'index.php?route=account/customerpartner/category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
    dataType: 'json',
...
'source': function(request, response) {
  $.ajax({
    url: 'index.php?route=customerpartner/autocomplete/filter&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
    dataType: 'json',
    success: function(json) {
      response($.map(json, function(item) {
        return {

Journal.contactPrivacy = parseInt('<?php echo $this->journal2->settings->get('popup_privacy_information.information_id'); ?>', 10);
Journal.contactPrivacyError = '<?php echo $this->journal2->settings->get('popup_privacy_information.information_error'); ?>';
...
Journal.infiniteScrollNoMoreItemsText = '<?php echo str_replace("'","\\'", $this->journal2->settings->get('infinite_scroll_no_more_items_text', 'Batas tampilan berakhir disini')); ?>';

...
class ControllerAccountAccount extends Controller {
	public function index() {
		if (!$this->customer->isLogged()) {
			...
			$this->session->data['redirect'] = $this->url->link('information/information', 'information_id=24', 'SSL');
		...
		if ($this->config->get('reward_status')) {
			...
			$data['reward'] = '';
              ...
              if($this->config->get('marketplace_status')) {
				  ...
				  $data['text_becomePartnertransporter'] = $this->language->get('text_becomePartnertransporter');
				  $data['text_becomePartnerbrand'] = $this->language->get('text_becomePartnerbrand');
				  ...
				  $data['want_partnertransporter'] = $this->url->link('account/customerpartner/become_partnertransporter','','SSL');
				  $data['want_partnerbrand'] = $this->url->link('account/customerpartner/become_partnerbrand','','SSL');
                  ...
                  $data['account_menu_href'] = array(
                     ...
                     //'dashboard' => $this->url->link('account/customerpartner/dashboard', '', 'SSL'),
					   'dashboard' => $this->url->link('information/information','information_id=24', 'SSL'),

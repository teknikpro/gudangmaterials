...
class ControllerModuleGallery extends Controller {
    ...
    $this->load->model('tool/image');
		...
		foreach ($results as $result) {
              ...
              'image' => ($setting['resize'] ? $this->model_tool_image->resize($result['image'], $this->config->get('config_image_popup_width'), $this->config->get('config_image_popup_height')) : $this->realname($result['image']))
    				);
    			}
		}
    ...
    $data['thumb_title'] = $setting['thumb_title'];    
		$data['module'] = $module++;

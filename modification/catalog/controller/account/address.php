...
class ControllerAccountAddress extends Controller {
	...
	public function optionaddress(){
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('account/address/optionaddress', '', 'SSL');
	...
	public function change() {
		...
		if (isset($this->request->get['address_id']) && $this->validateDelete()) {
			...
			$this->model_account_address->changeAddress($this->request->get['address_id']);

			$this->session->data['success'] = "Alamat berhasil dipilih";
	...
	public function addOption(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('account/address/optionaddress', '', 'SSL'));
		}
	...
	protected function getListOption() {
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'address'    => str_replace(array("\r\n", "\r", "\n"), '<br />', preg_replace(array("/\s\s+/", "/\r\r+/", "/\n\n+/"), '<br />', trim(str_replace($find, $replace, $format)))),
				'telephone'	=> $result['telephone'],
				'update'     => $this->url->link('account/address/editoption', 'address_id=' . $result['address_id'], 'SSL'),
				'change'     => $this->url->link('account/address/change', 'address_id=' . $result['address_id'], 'SSL')
			);
		}
		...
		$data['add'] = $this->url->link('account/address/addOption', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_option.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/account/address_option.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/account/address_option.tpl', $data));
		}
	}
	...
	protected function getFormOption(){
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('account/address/optionaddress', '', 'SSL')
		);

		if (!isset($this->request->get['address_id'])) {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_edit_address'),
				'href' => $this->url->link('account/address/addOption', '', 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_edit_address'),
				'href' => $this->url->link('account/address/editOption', 'address_id=' . $this->request->get['address_id'], 'SSL')
			);
		}
		...
		if (!isset($this->request->get['address_id'])) {
			$data['action'] = $this->url->link('account/address/addOption', '', 'SSL');
		} else {
			$data['action'] = $this->url->link('account/address/editOption', 'address_id=' . $this->request->get['address_id'], 'SSL');
		}
		...
		$data['back'] = $this->url->link('account/address/optionaddress', '', 'SSL');

      ...
      <div class="tab-content">
        ...
        <div class="tab-pane" id="tab-links">
          ...
          <div class="form-group <?php if($category_required){ ?>required<?php } ?>">
            ...
            <div class="col-sm-9">
              <a id="input-category" class="btn btn-primary" data-toggle="modal" data-target="#category-modal" style="margin-bottom: 10px;"><?php echo $text_addcategory; ?> </a>
              ...
              <?php foreach ($product_attributes as $product_attribute) { ?>
                <tbody id="attribute-row<?php echo $attribute_row; ?>">
                  <tr>
                    ...
                    <td class="text-left">
                      <button type="button" onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove(); $(\'.tooltip.in\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                    </td>
                  </tr>
                </tbody>
              <?php $attribute_row++; ?>
...
function addAttribute() {
  ...
  html += '<div class="input-group"><span class="input-group-addon"><img src="admin/view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div> ';
    <?php } ?>
  html += '    </td>';
  html += '    <td class="text-left"><button type="button" onclick="$(\'#attribute-row' + attribute_row + '\').remove(); $(\'.tooltip.in\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
    html += '  </tr>';
    html += '</tbody>';
...
function addImage() {
  ...
  html += '  <tr>';
  html += '  <td class="text-left"><div style="width:110px;height:110px;overflow:hidden" class="img-thumbnail wk_upload_img"><img id="thumb' + image_row + '-thumb-image" src="<?php echo $placeholder; ?>" alt="" title=""/></div><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="thumb' + image_row + '-target-image"/><div class="btn-group imgoption" style="width: 41%;"><button class="btn btn-danger btn-sm delete_img" type="button">Remove</button></div></td>';

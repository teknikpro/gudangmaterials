...
<div class="box specials">
	...
	<div class="box-content">
		<div class="product-layout">
			<ul class="specials-scroll list-unstyled">
			...
			<li>
				...
				<div class="quick_info">
					...
					<div class="cart-button">
						...
						<?php } ?>
					<div class="clear"></div>
						<button data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-icon btn-add" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i>
						</button>

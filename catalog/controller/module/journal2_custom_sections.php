...
class ControllerModuleJournal2CustomSections extends Controller {
    ...
    private function generateProductSections($sections_data) {
        ...
        foreach ($sections_data as $section) {
            ...
            $limit = $todays_specials ? PHP_INT_MAX : Journal2Utils::getProperty($section, 'items_limit', 6);
            ...
            foreach ($products as $product) {
                ...
                if (Journal2Utils::getProperty($section, 'section_type') === 'module' && Journal2Utils::getProperty($section, 'module_type') === 'specials'
                  ...
                  $this->load->model('catalog/product');
                    ...
                    $product_info_ = $this->model_catalog_product->getScreenname($product['product_id']);
                ...
                $product_data = array(
                    ...
                    'date_end'      => $date_end,
                    'rating'        => $rating,
                    'description'   => utf8_substr(strip_tags(html_entity_decode($product['description'], ENT_QUOTES, 'UTF-8')), 0, 37) . '..',
                    'tax'           => $tax,

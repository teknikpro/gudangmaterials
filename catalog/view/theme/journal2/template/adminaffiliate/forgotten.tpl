                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Masukan Email, dan Password baru akan dikirim melalu email yang
                                            dicantumkan</p>
                                    </div>
                                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="user">
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control form-control-user" placeholder="Masukan Email" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-user btn-block">Reset Password</button>
                                    </form>

                                    <div class="text-center">
                                        <a class="small" href="<?= $back; ?>">Sudah Punya Akun? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>

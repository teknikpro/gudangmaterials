  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      ...
      <div class="pull-right">
		...
		<a href="<?php echo $insert; ?>"  data-toggle="tooltip" title="Add new" class="btn btn-primary"><i class="fa fa-plus"></i></i></a>
		...
		<table class="table table-bordered table-hover">
          <thead>
            <tr>
			  ...
			  <td class="right"><?php echo "Seller"; ?></td>
			  <td class="right"><?php echo "Customer"; ?></td>
				<!--<div class="col-sm-6">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left"<?php echo $column_customer; ?></td>	-->		  
			   ...
			   <td class="left"><?php echo ""; ?></td>-->
			  <td class="left"><?php echo $chatting['seller_name']; ?></td>
              <td class="left"><?php echo $chatting['customer_name']; ?></td>

<ul id="menu">
  <li id="dashboard"><a href="<?php echo $home; ?>"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_dashboard; ?></span></a></li>
		...
		<li id="extension"> <a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i><span>Payment Order</span></a>
			<ul class="halalmenu">
                <li> <a class="parent"><?php echo "Paymment Confirmation"; ?></a>
                ...
                <li id="bundle"><a href="<?php echo $hp_order_tracking; ?>"><?php echo "Order Tracking"; ?></a></li>		
        ...
        <li id="customerpartner"><a class="parent"><i class="fa fa-users"></i> <span><?php echo "Marketplace"; ?></span></a>
          <ul>
            ...
            <li><a href="<?php echo $cp_konfirmasiongkir ?>">Konfirmasi Ongkir</a></li>

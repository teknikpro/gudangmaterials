  ...
  <table class="table table-bordered table-hover">
    <tbody>
      <tr>
        ...
        <td><strong><?php print "  #".$j; ?><?php print " reply on : "; ?></strong> <a href="<?php print $base.'index.php?route=module/forum/getForums&author_id='.base64_encode($forumreplydata[$i]['customer_id']);?>"><?php print $forumreplydata[$i]['username']; ?></a> </td>
      ...
      <tr>
		...
		if (in_array($ext, $supported_image)) {
		?>
         <!--<td><img style="width:20px; height:20px;" src="<?php print $base.'image/'.$forumreplydata[$i]['avatar'];  ?>"/> </td>-->
        <?php } else { ?>
         <!--<td><img style="width:20px; height:20px;" src="image/data/admin.png"/> </td>-->
        <?php  } ?>
		
		<td><?php echo html_entity_decode($forumreplydata[$i]['reply']); ?></td>
      </tr>
    </tbody>
  </table>
  <?php $j++; ?>
